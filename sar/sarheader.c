...
* ***************************************
*/
int _minor_version = 0x1;
int _major_version = 0x2;
int _source_count  = 0x3;
int _source_files  = 0x4;
int file_size      = 0x5;
int _next_file     = 0x6;
int _eoh           = 0x7;
...
void encodeheader()
{
    archive << offset(1) << "SAR     " << offset(11) << magic() << minvers() << offset(1) << majvers() << offset(1) 
            << scount() << offset(1) << sfiles() << offset(1) << (char)_eoh << offset(12) << "\n" << offset(20);
}
