 ...
 */
 ...
 bool scorpionvm::memory::schema::object_scheme_controller::isnumber(ObjectSchema::t type)
 {
 ...
 bool scorpionvm::memory::schema::object_scheme_controller::isnumber(ObjectContainer &container)
 {
     return !container.array && container.init && (container.valuetype->type == ObjectSchema::SBOOL 
 ...
 void scorpionvm::memory::schema::object_scheme_controller::arrycpy(ObjectContainer &container, ObjectContainer &container2)
 {
     // TODO: use memcpy()
 }
 
 int scorpionvm::memory::schema::object_scheme_controller::create_object(ObjectContainer &container, 
     ObjectSchema::t type, uint64_t array)
 {
     ...
     scorpionvm::scorpion_assert(container.gc_ != gc::gc_dirty, "(container.gc_ != gc::gc_dirty)");
 ...
 int scorpionvm::memory::schema::object_scheme_controller::kill_object(ObjectContainer &container)
 {
     scorpionvm::scorpion_assert(container.gc_ != gc::gc_idle &&
               container.gc_ != 0, "(container.gc_ != gc::gc_idle &&\n\tcontainer.gc_ != 0)");
 }
 
 int scorpionvm::memory::schema::object_scheme_controller::delete_object(ObjectContainer &container)
 {
     if(container.init)
