...
int destroy_state(struct scorpion_state* s_state, int N);
/**
...
struct scorpion_gstate
{
    ...
    scorpion_state* g_state; // pointer the current Scorpion state we are executing
};
