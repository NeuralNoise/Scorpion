                                                 ...
                                                 if(read_char() == (char)flag_logging)
                                                 {
                                                     ...
                                                     if(read_char() == (char)flag_log_precedence)
                                                     {
                                                         ...
                                                         if(read_char() == (char)flag_log_file)
                                                         {
                                                             ...
                                                             {
                                                                 xso_file.xso_header.application_id = xso_text();
                                                                 i++;
                                                                 ...
                                                                 if(read_char() == (char)flag_permissions)
                                                                 {
                                                                     ...
                                                                     if(read_char() == (char)flag_address_cap)
                                                                     {
                                                                         string str = xso_text(true);
                                                                         xso_file.xso_header.address_cap.byte1 = atol(str.c_str());
                                                                         cout << "address cap " << str << endl;
                                                                         i +=33;
